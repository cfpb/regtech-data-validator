...
This is a RegTech submission data parser and validator which makes use of Pandera. You can read about Pandera schemas [here](https://pandera.readthedocs.io/en/stable/dataframe_schemas.html).  This library allows users to validate SBL Data in CSV format and return
...
When some validations failed, it prints out:
