...
def get_template_by_phase(template, validation, lei: str):
...
def get_phase_1_schema(lei: str):
    return get_template_by_phase(phase_1_template, "phase_1", lei)


def get_phase_2_schema(lei: str):
    return get_template_by_phase(phase_2_template, "phase_2", lei)
