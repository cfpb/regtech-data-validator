...
def df_to_download(df: pd.DataFrame, warning_count: int = 0, error_count: int = 0, max_errors: int = 1000000) -> str:
    ...
    if df.empty:
        ...
        if total_errors and total_errors > max_errors:
            header += f"Your register contains {total_errors} {error_type}, however, only {max_errors} records are displayed in this report. To see additional errors, correct the listed records, and upload a new file.\n"
