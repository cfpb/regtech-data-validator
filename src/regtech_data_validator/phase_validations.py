        ...
        "ct_credit_product_ff": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="ct_credit_product",
        ...
        "ct_loan_term": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="ct_loan_term_flag",
        ...
        "amount_applied_for": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="amount_applied_for_flag",
                    condition_values={"900"},
                ),
                SBLCheck(
                    is_greater_than,
        ...
        "pricing_init_rate_period": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="pricing_interest_rate_type",
        ...
        "pricing_adj_index_name_ff": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="pricing_adj_index_name",
                    condition_values={"977"},
                ),
            ],
        },
        ...
        "pricing_mca_addcost": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="pricing_mca_addcost_flag",
                    condition_values={"900"},
                ),
            ],
        },
        ...
        "census_tract_number": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="census_tract_adr_type",
                    conditions=[
                        {
        ...
        "gross_annual_revenue": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="gross_annual_revenue_flag",
                    condition_values={"900"},
                ),
            ],
        },
        ...
        "naics_code": {
            ...
            ValidationPhase.LOGICAL: [
                ...
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="naics_code_flag",
                    condition_values={"900"},
                ),
            ],
        },
        ...
        "time_in_business": {
            ...
            ValidationPhase.LOGICAL: [
                ...
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="time_in_business_type",
                    condition_values={"1"},
                ),
            ],
        },
        ...
        "num_principal_owners": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="num_principal_owners_flag",
                    condition_values={"900"},
                ),
                SBLCheck(
                    has_valid_fieldset_pair,
        ...
        "po_1_gender_ff": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="po_1_gender_flag",
                    condition_values={"1"},
                ),
            ],
        },
        ...
        "po_2_gender_ff": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="po_2_gender_flag",
                    condition_values={"1"},
                ),
            ],
        },
        ...
        "po_3_gender_ff": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="po_3_gender_flag",
                    condition_values={"1"},
                ),
            ],
        },
        ...
        "po_4_gender_ff": {
            ...
            ValidationPhase.LOGICAL: [
                SBLCheck(
                    ...
                    severity=Severity.ERROR,
                    scope="multi-field",
                    groupby_fields="po_4_gender_flag",
                    condition_values={"1"},
                ),
            ],
        },
